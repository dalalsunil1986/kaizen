<div class="row">
    {{ Form::open(array('action' => 'EventsController@index','method'=>'get','class'=>'form-inline')) }}
        ...
        <div class="form-group col-md-12">
            <input type="text" class="form-control" id="search" name="search" value="@if(isset($search)) {{ $search }} @endif "  placeholder="{{ trans('site.keyword') }}">
        </div>
        ...
        <div class="form-group col-md-1 top7">
            <button type="submit" class="btn btn-default btn-small">{{ Lang::get('site.search') }}</button>
        </div>
